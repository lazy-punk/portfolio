  ...
  const achievements = [
    {
      ...
      date: '2024-2025',
      description: 'Active Kaggler competing in machine learning challenges. Check out my profile to see my latest competitions and notebooks!',
      items: [
        'Digit Recognition Challenge (39/1600)',
        'Insurance Regression Challenge (269/2390)',
        'Titanic Challenge (3800/16000)',
      ],
